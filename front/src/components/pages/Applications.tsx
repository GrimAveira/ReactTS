...
//           })
//           .then((response) =>
//             setStatus(response.data.map((value) => value.name))
//           )
...
//           })
//           .then((response) =>
//             setBreaking(response.data.map((value) => value.name))
//           )
//           .catch((error) => console.log(error));
//         axios
...
//             },
//           })
//           .then((response) => setType(response.data.map((value) => value.name)))
//           .catch((error) => console.log(error));
//         axios
...
//         )}
//         {localStorage.getItem("role") === "2"
//           ? applications[counter].map((post) => {
//               return (
//                 <UserApplication
//                   key={post.id}
//                   {...post}
//                   employees={employeesApp[post.id] || []}
//                 />
//               );
//             })
//           : applications[counter].map((post) => {
...
//                   key={post.id}
//                   {...post}
//                   employeesApp={employeesApp[post.id] || []}
